...
class Host(BaseModel):
    host_id = models.IntegerField('网站id', primary_key=True, auto_created=True, help_text='网站id')
    host_name = models.CharField('网站名称', max_length=255)
    applicant = models.CharField('申请检测单位', max_length=255)
...
class Rule(BaseModel):
    ...
    rule_id = models.IntegerField('检测规则id', primary_key=True, auto_created=True)
...
class Page(BaseModel):
    page_id = models.IntegerField('网页id', primary_key=True, auto_created=True)
    host_id = models.IntegerField('网站id')
    local_dir = models.CharField('本地地址', max_length=255)
